...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListItem Value="editUsers">EditUser</asp:ListItem>
    </asp:DropDownList>
    ...
    <div runat="server" id="editUser" visible="false">
    Customer: 
        <asp:DropDownList ID="drpDownListCustomers" runat="server">
        </asp:DropDownList>
        &nbsp;<asp:Button ID="btnEdit" runat="server" onclick="btnEdit_Click" 
            Text="Edit" />
        <asp:GridView ID="GridViewCustomers" runat="server" 
            AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="GridViewCustomers_RowDeleting" OnRowEditing="GridViewCustomers_RowEditing" OnRowUpdating="GridViewCustomers_RowUpdating">
        </asp:GridView>
